...
int GigEsetMirrorType(DataProcessType mirrortype,int camNum)
{
	if(camNum<1)return camNum;
	camNum=camNum-1;
...
int GigEsendOrder(camPropStruct camprop,int camNum,int s)
{
	if(camNum<1)return camNum;
	camNum=camNum-1;
...
int GigEsendProp(clientPropStruct prop,int camNum)
{
	if(camNum<1)return camNum;
	camNum=camNum-1;
